...
#define SERVICE_UUID "f6024b44-c65f-11f0-8de9-0242ac120002"
#define CHARACTERISTIC_UUID "004dac4c-c660-11f0-8de9-0242ac120002"
...
void setup()
{
  ...
  advertising->setName("ESP32_Ori_Sensor_Shoulder");
  advertising->start();
